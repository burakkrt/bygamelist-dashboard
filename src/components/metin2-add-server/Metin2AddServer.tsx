              ...
              <Grid container spacing={2}>
                ...
                <Grid xs={6}>
                  <FormControl fullWidth>
                    <InputLabel id="status-select-label">Paylaşım durumu *</InputLabel>
                    <Select
                      ...
                      required
                      onChange={(e) => parseBooleanhandleChange('status', e.target.value)}
                    >
                ...
                <Grid xs={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      label="Auto Boss"
                      onChange={(e) =>
                        parseBooleanhandleChange('autoBoss', e.target.value)
                      }
                    >
                      <MenuItem value="true">Var</MenuItem>
                      <MenuItem value="false">Yok</MenuItem>
                ...
                <Grid xs={6}>
                  <FormControl fullWidth>
                    <InputLabel id="ownSalesSystem-select-label">
                      Satış sistemi
                    </InputLabel>
                    <Select
                ...
                <Grid xs={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      label="Kule Farmı"
                      onChange={(e) =>
                        parseBooleanhandleChange('kuleFarm', e.target.value)
                      }
                    >
                      <MenuItem value="true">Var</MenuItem>
                      <MenuItem value="false">Yok</MenuItem>
