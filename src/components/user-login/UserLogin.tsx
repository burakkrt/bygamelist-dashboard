...
import { IUserLoginProps, IUserLoginFormValues } from './types'

function UserLogin({}: IUserLoginProps) {
  ...
  return (
    <div className="user-login">
      <div className="header">
        <div className="logo">
          <Image src="/images/site/bygamelist-logo.png" alt="ByGameList Logo" priority />
        </div>
